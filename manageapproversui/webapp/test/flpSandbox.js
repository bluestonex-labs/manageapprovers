		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ukcobrakesrfmanageapproversui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ukcobrakesrfmanageapproversui-display": {
								"semanticObject": "ukcobrakesrfmanageapproversui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uk.co.brakes.rf.manageapproversui",
									"url": sap.ui.require.toUrl("uk/co/brakes/rf/manageapproversui")
								}
							}
						}
					}
